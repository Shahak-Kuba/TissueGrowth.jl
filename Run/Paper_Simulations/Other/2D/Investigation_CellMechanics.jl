...
Plots.vline!([10], linewidth=3, linestyle=:dash,label="Resting length")
Plots.vline!([5], linewidth=3, linestyle=:dash,label="Minimum length")
Plots.vline!([20], linewidth=3, linestyle=:dash,label="Maximum length")
#Plots.plot!(x, nonlinear_lim,linewidth=3,linestyle=:dash, label="Nonlinear Limit")

save("Force_Compare_2D_Square.png", f)