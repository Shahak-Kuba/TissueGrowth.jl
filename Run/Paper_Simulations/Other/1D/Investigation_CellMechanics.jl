...
Aₕ = (l_min, l_max, p) -> p.k * ((l_min^2 - l_max^2)/2 + p.a(l_min - l_max))
Aₙ = (l_min, l_max, p) -> p.k * p.a^2 *((l_max - l_min)/a - log(l_min/l_max))
...
kₕ = 12.5
aₕ = 0.0184657986343769
pₕ = (k = kₕ, a = aₕ)

hookean = F₁(x,pₕ)

kₙ = 12.5
aₙ = 0.0184657986343769
pₙ = (k = kₙ, a = aₙ)
