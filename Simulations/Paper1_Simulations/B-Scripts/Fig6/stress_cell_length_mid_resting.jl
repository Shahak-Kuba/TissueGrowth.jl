...
save("Fig7_Mid_Hookean_Cell_Length.png", f_length_Hookean)
save("Fig7_Mid_Hookean_Stress.png", f2_hookean)

save("Fig7_Mid_Nonlinear_Cell_Length.png", f_length_Nonlinear)
save("Fig7_Mid_Nonlinear_Stress.png", f2_nonlinear)