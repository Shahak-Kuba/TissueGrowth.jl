...
save("Fig6_Low_Hookean_Cell_Length.png", f_length_Hookean)
save("Fig6_Low_Hookean_Stress.png", f2_hookean)

save("Fig6_Low_Nonlinear_Cell_Length.png", f_length_Nonlinear)
save("Fig6_Low_Nonlinear_Stress.png", f2_nonlinear)
