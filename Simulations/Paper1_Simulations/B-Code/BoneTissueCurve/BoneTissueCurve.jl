...
fig_interface_hookean = TissueGrowth.plotResults1D(sol_hookean[geo][diffusivity][1].u, sol_hookean[geo][diffusivity][1].Density, cmap, crange,  L"\text{Density} \; q \; \text{[1/μm]}", D[diffusivity], kf, m, N, 10)
